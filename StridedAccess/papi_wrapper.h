...
// Check if PAPI is available via compile flag
#ifdef USE_PAPI
#include <papi.h>
#include <omp.h>
...
#else // !USE_PAPI - Stub implementations

static bool g_papi_enabled = false;

static void init_papi(const char*) { g_papi_enabled = false; }
static void start_papi_thread() {}
static void stop_papi_thread() {}
static void init_papi_single_thread(const char*) { g_papi_enabled = false; }
static void start_papi_single_thread() {}
static void stop_papi_single_thread() {}
static long long get_papi_value() { return 0; }
